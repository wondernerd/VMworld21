...
def create_config_spec(datastore_name, name, memory=4, guest="otherGuest",
    ...
    config.deviceChange[0].device.deviceInfo = vim.Description()
    config.deviceChange[0].device.deviceInfo.summary = 'NVIDIA GRID vGPU grid_p4-4q'
    config.deviceChange[0].device.deviceInfo.label = 'New PCI device'
    config.deviceChange[0].device.backing = \
